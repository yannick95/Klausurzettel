...
\usepackage[top=0.2cm, left=0.2cm, right=0.2cm, bottom=0.2cm]{geometry}
...
\usepackage[letterspace=-100]{microtype} %% siehe hier: http://homepage.ruhr-uni-bochum.de/Georg.Verweyen/pakete.html
...
\hline
$\Lambda^0\rightarrow p+\pi^-$ & $\surd$ & schwache WW/schwach+stark\\
\hline
$\overline{p}+n\rightarrow\pi+\pi^++\pi$ & $\surd$ & starke WW \\
\hline
$\mu^-\rightarrow e^-+\gamma$ & x & Leptonfamilienzahl\\
\hline
$n\rightarrow\pi^+\pi^-$ & x & Baryonenzahl\\
\hline
$\rho(770)\rightarrow\pi^+\pi^-$ & $\surd$ & starke WW\\
\hline
$K^0\rightarrow\pi^-+\pi^+$ & $\surd$ & schwach (+stark)\\
\hline
$K^++n\rightarrow\Lambda^0+\pi^+$ & x & $\Delta$S=2 \\
\hline
$H^0$$\rightarrow$$\mu^+$$\mu^-$+$\mu^+$$\mu^-$ & $\surd$ & schwache WW\\
\hline
$\cdots$ & $\cdots$ & $\cdots$\\
\hline
$\cdots$ & $\cdots$ & $\cdots$\\
